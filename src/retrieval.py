...
from .utils import estimate_tokens, normalize_ocr_text, strip_embedding_prefix
from config import QUERY_PREFIX, PASSAGE_PREFIX, VECTOR_SEARCH_K, BM25_SEARCH_K, FINAL_TOP_K, HYBRID_ALPHA, USE_RERANKER, RERANKER_MODEL, USE_ONNX_RERANKER, USE_HYDE, EMBEDDING_PROVIDER, METADATA_DIR, SEMANTIC_CACHE_ENABLED, SEMANTIC_CACHE_THRESHOLD, SEMANTIC_CACHE_MAX_CANDIDATES, USE_USHAPED_CONTEXT, MAX_TABLE_ROWS_IN_PROMPT, MAX_TABLE_TOKENS_IN_PROMPT
...
class HybridRetriever:
    ...
    def search(self, query: str, k: int = FINAL_TOP_K, model_filter: str = "", use_hyde: Optional[bool] = None) -> List[RetrievalResult]:
